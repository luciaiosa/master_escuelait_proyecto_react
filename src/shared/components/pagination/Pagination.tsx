...
import { setPaginationEllipseLowerPagesNumber, setPaginationEllipseUpperPagesNumber, setPaginationSelectedPage } from "@/stores/pagination/Actions";
...
const Pagination: FunctionComponent<IPagerProps> = (
    props: IPagerProps
): JSX.Element => {
